...
namespace Pixelplacement {
	...
	public sealed class ColliderButton : MonoBehaviour {
		...
		public Color disabledColor = new(.5f, .5f, .5f, .5f);
		...
		//Private Methods:
		void ResizeGUIBoxCollider(BoxCollider boxCollider) {
			if (!resizeGUIBoxCollider) return;
			boxCollider.size = new Vector3(_rectTransform.rect.width + guiBoxColliderPadding.x,
			_rectTransform.rect.height + guiBoxColliderPadding.y, _boxCollider.size.z);
		...
		void ColorNormal() {
			...
			if (colorRendererTarget != null && colorRendererTarget.material.HasProperty("_Color")) {
				_colorTweenMaterial = Tween.Color(colorRendererTarget, _normalColorRenderer, colorDuration, 0, null, Tween.LoopType.None,
				null, null, false);
			}
		...
		void ColorSelected() {
			...
			//tween material color:
			if (colorRendererTarget != null && colorRendererTarget.material.HasProperty("_Color")) {
				_colorTweenMaterial = Tween.Color(colorRendererTarget, selectedColor, colorDuration, 0, null, Tween.LoopType.None, null,
				null, false);
			}
		...
		void ColorPressed() {
			...
			//tween material color:
			if (colorRendererTarget != null && colorRendererTarget.material.HasProperty("_Color")) {
				_colorTweenMaterial = Tween.Color(colorRendererTarget, pressedColor, colorDuration, 0, null, Tween.LoopType.None, null, null,
				false);
			}
		...
		void ColorDisabled() {
			...
			//tween material color:
			if (colorRendererTarget != null && colorRendererTarget.material.HasProperty("_Color")) {
				_colorTweenMaterial = Tween.Color(colorRendererTarget, disabledColor, colorDuration, 0, null, Tween.LoopType.None, null,
				null, false);
			}
